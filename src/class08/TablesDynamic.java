...
//        click on login button
        ...
        //task:check
        List<WebElement> cloumn=driver.findElements(By.xpath("//table[@class='SampleTable']/tbody/tr/td[3]"));
        for (int i = 0; i < cloumn.size() ; i++) {
            String text=cloumn.get(i).getText();
            if ((text.equalsIgnoreCase("ScreenSaver"))){
                System.out.println(text);
                System.out.println("ScreenSaver is located at row number"+(i+2));
